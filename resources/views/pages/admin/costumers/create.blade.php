        ...
        <div class="col-md-12">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-user"></i> TAMBAH COSTUMERS</h6>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.costumers.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
